...
<div id="wcst_tracking_form_<?php echo $unique_id; ?>" class="wcst_tracking_form">
	...
	<?php else: ?>
	<label class="wcst_shipping_company_select_label"><?php esc_html_e('Select a company:','woocommerce-shipping-tracking');?></label>
	...
	<label class="wcst_tracking_code_input_label"><?php esc_html_e('Type the tracking code:','woocommerce-shipping-tracking');?></label>
	...
	<button class="wcst_tracking_code_button button <?php echo $button_classes; ?>" id="wcst_tracking_code_button_<?php echo $unique_id; ?>" data-id="<?php echo $unique_id; ?>"><?php esc_html_e('Track','woocommerce-shipping-tracking');?></button>
</div>
