...
<p id="sbDesc"><?php echo sprintf( __( 'This page lets you set some global List View settings. These affect pages like the <a href="%s">Contact List view</a>.', 'zero-bs-crm' ), zbsLink($zbs->slugs['managecontacts']) ); ?></p>
...
<div id="sbA">
    <form method="post" action="?page=<?php echo $zbs->slugs['settings']; ?>&tab=listview" id="zbslistviewform">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_notcontactedinx"><?php _e( 'Not Contacted in X Days', 'zero-bs-crm' ); ?>:</label><br /><?php _e('Enter the number of days to use in this filter.',"zero-bs-crm"); ?><br /><?php _e('For example, show contacts not contacted in the last 10 days.',"zero-bs-crm"); ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_olderthanx"><?php _e( 'Older than X days', 'zero-bs-crm' ); ?>:</label><br /><?php _e('Enter the number of days to use in this filter.',"zero-bs-crm"); ?><br /><?php _e('For example, show contacts older than 30 days.',"zero-bs-crm"); ?></td>
                <td style="width:540px">
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_show_totals_table"><?php _e( 'Show Totals Table', 'zero-bs-crm' ); ?>:</label><br /><?php _e('When viewing a contact list, show the totals table on the sidebar',"zero-bs-crm"); ?></td>
                <td style="width:540px">
