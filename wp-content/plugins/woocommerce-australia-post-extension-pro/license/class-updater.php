...
class Updater {
	 ...
	 */
	public function __construct( $_api_url, $_plugin_file, $_api_data = null, $license_page_url = '' ) {
	...
	private function get_version_from_remote() {
		...
		if ($this->plugin_file === 'woocommerce-australia-post-extension-labels-pro/australian-post.php') {
			$api_params['plugin_file'] = 'labels-pro';
		}
	...
	public function plugin_row_license_missing( $plugin_data, $version_info ) {
		echo '&nbsp;<strong><a target="_blank" href="' . esc_url( $this->license_page_url ) . '">' . __( 'Make sure to enter valid license key for automatic updates.', 'woocommerce-australia-post-pro' ) . '</a></strong>';
	}
