...
function jpcrm_wplogin_footer(){
	...
	if ( $wptakeovermodeforall && $showpoweredby_public ) {
		echo '<div style="text-align:center;margin-top:1em;font-size:12px"><a href="' . $zbs->urls['home'] . '" title="' . __( 'Powered by Jetpack CRM', 'zero-bs-crm' ) . '" target="_blank">' . __( 'Powered by Jetpack CRM', 'zero-bs-crm' ) . '</a></div>';
	}
