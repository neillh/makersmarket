                        ...
                        <?php
                          ...
                          if (is_array($zbsFiles) && count($zbsFiles) > 0){ 
                            ...
                            $fileLineIndx = 0; foreach($zbsFiles as $zbsFile){                              
                              ...
                              ?><tr>
                                <td>
                                  <h4><?php echo !empty( $zbsFile['title'] ) ? esc_html( $zbsFile['title'] ) : __( 'Untitled', 'zero-bs-crm' ); ?></h4>
                                  <p>
                                  ...
                                  <em>(<?php echo esc_html( $file ); ?>)</em>
                                      ...
                                      <td class="center aligned">
                                          <?php 
                                              echo '<a class="" href="' . esc_url( $zbsFile['url'] ) . '" target="_blank" class="ui button basic">' . __( 'View', 'zero-bs-crm' ) . '</a>';
                                      ...
                                      <td class="center aligned">
                                        ...
                                        <button class="zbsDelFile ui button basic" data-type="company" data-delurl="<?php echo esc_attr( $zbsFile['url'] ); ?>"><i class="trash alternate icon"></i><?php _e("Delete","zero-bs-crm"); ?></button>
                                      </td>
                              </tr><?php
