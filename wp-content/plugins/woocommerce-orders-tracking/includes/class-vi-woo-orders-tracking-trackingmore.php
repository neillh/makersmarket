	...
	class VI_WOOCOMMERCE_ORDERS_TRACKING_TRACKINGMORE {
		...
		public static function update_tracking_data( $trackings, $change_order_status = '' ) {
			foreach ( $trackings as $tracking ) {
				...
				if ( $status ) {
					VI_WOOCOMMERCE_ORDERS_TRACKING_ADMIN_ORDERS_TRACK_INFO::update_order_items_tracking_status( $tracking_number, self::get_carrier_slug_by_trackingmore_slug( $carrier_id ), $status, $change_order_status );
				}
			}
		}
