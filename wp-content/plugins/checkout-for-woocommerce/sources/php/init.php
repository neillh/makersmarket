...
use Objectiv\Plugins\Checkout\Compatibility\Plugins\AeliaTaxDisplayByCountry;
...
add_filter(
	...
	function ( $fields ) {
		...
		$enabled_fields = SettingsManager::instance()->get_setting( 'enabled_billing_address_fields' );
...
$compatibility_modules = array(
	...
	AeliaTaxDisplayByCountry::instance(),
	NMI::instance(),
