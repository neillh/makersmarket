...
<div class='bwfan-email-cart-table bwfan-email-table-wrap'>
    <table cellspacing="0" cellpadding="6" border="1" width="100%">
        ...
        <tr>
            ...
            <th class="td" scope="col" style="width:90px;<?php esc_html_e( $text_align ); ?> white-space: nowrap;"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
            <th class="td" scope="col" style="width:90px;<?php esc_html_e( $text_align ); ?> white-space: nowrap;"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
        </tr>
        </thead>
        <tbody>
		...
		if ( false !== $cart ) {
			foreach ( $cart as $item ) :
                ...
                <tr>
					...
					?>
                    <td>
                        <h4 style="vertical-align:middle; <?php esc_html_e( $text_align ); ?>">
