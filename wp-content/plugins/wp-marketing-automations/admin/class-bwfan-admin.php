	...
	public function register_admin_menu() {
		...
		if ( false === bwfan_is_autonami_pro_active() ) {
			...
			if ( strtotime( gmdate( 'c' ) ) < 1669438800 ) {
				...
				add_submenu_page( 'autonami', null, '<a href="' . $link . '"  target="_blank">' . __( 'Black Friday!', 'wp-marketing-automations' ) . '</a>', $capability, 'upgrade_pro', function () {
				}, 61 );
				...
				add_submenu_page( 'autonami', null, '<a href="' . $link . '"  target="_blank">' . __( 'Cyber Monday!', 'wp-marketing-automations' ) . '</a>', $capability, 'upgrade_pro', function () {
				}, 61 );
			}
		}
	}
