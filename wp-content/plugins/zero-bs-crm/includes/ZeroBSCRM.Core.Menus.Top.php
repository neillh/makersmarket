			...
			<div class="ui simple dropdown item select<?php zeroBS_menu_active_type('contact'); ?>" id="zbs-contacts-topmenu" style="min-width:114px;z-index:2">
				...
				<div class="menu ui inverted zbs-admin-bg-menu zbs-dropdown">
				  ...
				  <div class="ui divider"></div>
					...
					<a class="item" href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['export-tools']);?>"><i class="icon cloud download"></i> <?php _e("Export","zero-bs-crm"); ?></a>
						<?php
		  ...
		  if (zeroBSCRM_permsViewQuotes() && zeroBSCRM_getSetting('feat_quotes') > 0){ ?>
			<div class="ui simple dropdown item select<?php zeroBS_menu_active_type('quote'); ?>" id="zbs-quotes-topmenu" style="z-index:5">
				...
				<div class="menu ui inverted zbs-admin-bg-menu zbs-dropdown">
					...
					<?php if ( zeroBSCRM_permsQuotes() ) { ?>
					<a class="item" href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['export-tools']);?>&zbstype=quote"><i class="icon cloud download"></i> <?php _e("Export","zero-bs-crm"); ?></a>
					<?php } ?>
		  ...
		  <?php if(zeroBSCRM_permsViewInvoices() && zeroBSCRM_getSetting('feat_invs') > 0){ ?>
			<div class="ui simple dropdown item select<?php zeroBS_menu_active_type('invoice'); ?>" id="zbs-invoices-topmenu" style="z-index:5">
				...
				<div class="menu ui inverted zbs-admin-bg-menu zbs-dropdown">
					...
					<a class="item" href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['export-tools']);?>&zbstype=invoice"><i class="icon cloud download"></i> <?php _e("Export","zero-bs-crm"); ?></a>
					<?php } ?>
		  ...
		  <?php if (zeroBSCRM_permsViewTransactions() && zeroBSCRM_getSetting('feat_transactions') > 0){ ?>
			<div class="ui simple dropdown item select<?php zeroBS_menu_active_type('transaction'); ?>" id="zbs-transactions-topmenu" style="z-index:5">
				...
				<div class="menu ui inverted zbs-admin-bg-menu zbs-dropdown">
					...
					<a class="item" href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['export-tools']);?>&zbstype=transaction"><i class="icon cloud download"></i> <?php _e("Export","zero-bs-crm"); ?></a>
					<?php } ?>
			      ...
			      <div class="ui link list">
					...
					<?php // welcome tour and crm resources page for admins :)
				  	if (zeroBSCRM_isZBSAdminOrAdmin()){
						...
						<a id="crm-resources-top-menu-dash" href="<?php echo zeroBSCRM_getAdminURL( $zbs->slugs['crmresources'] ); ?>" class="item"><i class="icon building"></i> <?php _e( 'Resources', 'zero-bs-crm' ); ?></a>
						<?php ##/WLREMOVE 
					} ?>
			      </div>
			    </div>
