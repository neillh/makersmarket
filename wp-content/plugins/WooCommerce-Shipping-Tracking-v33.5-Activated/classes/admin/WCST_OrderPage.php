...
class WCST_OrderPage
{
	...
	function woocommerce_metaboxes() 
	{
		...
		add_meta_box( 'woocommerce-order-ship', esc_html__('Tracking Code', 'woocommerce-shipping-tracking'), array( &$wcst_html_helper, 'render_shipping_companies_tracking_info_configurator_widget' ), 'shop_order', 'side', 'high');
