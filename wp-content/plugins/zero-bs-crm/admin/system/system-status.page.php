        ...
        <div id="sbA" style="margin-right:1em">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="width:540px"><?php  
                              ...
                              } else echo __( 'Not yet run', 'zero-bs-crm' );
              ...
              <table class="table table-bordered table-striped wtab">
                   ...
                   <thead>
                        ...
                        <tr>
                            <th colspan="2" class="wmid"><?php _e( 'Packages Installed:', 'zero-bs-crm' ); ?></th>
                        </tr>
                      ...
                      <?php
                        ...
                        if ( is_array( $packages ) && count(  $packages ) > 0 ){
                          ...
                          foreach ( $packages as $package_key => $package_info ){
                            ...
                            ?><tr class="package-<?php echo $package_key; ?>">
                                <td><?php echo $package_info['title']; ?></td>
                                <td><?php 
                                  
                                  if ( is_array( $package_info['installed'] ) ){

                                    echo sprintf( __( 'Version %s Installed', 'zero-bs-crm' ), number_format( $package_info['installed']['version'], 1 ) );

                                  } else {
                                  
                                    _e( 'Not Installed', 'zero-bs-crm' );

                                    // retrieve failed_installs
                                    if ( isset( $package_info['failed_installs'] ) && $package_info['failed_installs'] > 0 ){

                                      echo '<br><i class="exclamation triangle icon red"></i> ' . sprintf( __( '%d attempts to install this package failed. Please <a href="%s" target="_blank">contact support</a>.', 'zero-bs-crm' ), $package_info['failed_installs'],  $zbs->urls['support'] );
