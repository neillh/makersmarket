...
function export_preflight_error( $message ) {
	echo '<h2>' . $message . '</h2><button class="ui blue button" onclick="history.back()">Go Back</button>';
}
...
function zeroBSCRM_page_exportRecords(){
	...
	<h2><?php echo __('Export','zero-bs-crm').' '.zeroBSCRM_prettifyLongInts($obj_count).' '.$exportTypeLabel; ?></h2>
	...
	// select all ?>
	<button type="button" class="ui blue mini button right floated all" id="zbs-export-select-all" ><span class="all"><i class="object ungroup icon"></i> <?php _e('Deselect All','zero-bs-crm'); ?></span><span class="none" style="display:none"><i class="object group icon"></i> <?php _e('Select All','zero-bs-crm'); ?></span></button>
