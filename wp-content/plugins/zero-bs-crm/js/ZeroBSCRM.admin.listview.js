...
function zeroBSCRMJS_initListView(){
                    ...
                    jQuery.ajax({
                          ...
                          success: function(response) {
                                ...
                                if (typeof response != "undefined" && response !== null && typeof response.objects != "undefined"){
                                    ...
                                    } else window.jpcrm_totals_table = false;
        ...
        function zeroBSCRMJS_listViewBulkActions() {
            ...
            html = '<div class="jpcrm-bulk-actions">\
                        ...
                        <button disabled class="jpcrm-bulk-actions-button ui tiny button primary" style="margin-left:0.4em">' + zeroBSCRMJS_listViewLang('go_button') + '</button>\
                    </div>';
            return html;
        }
        ...
        function zeroBSCRMJS_listViewLine(data){
            ...
            if (window.zbsListViewParams.columns.length > 0){ //&& window.zbsListViewParams.columns.length == data.length){
                ...
                var lineHTML = '<tr' + trAttr + '>';
                    ...
                    // only if there's any bulk actions to use!
                    if (typeof window.zbsBulkActions != "undefined" && window.zbsBulkActions.length > 0) {
                        lineHTML += '<td class="zbs-listview-bulk"><div class="ui fitted checkbox"><input type="checkbox" id="zbsbulk' + data['id'] + '" data-entityid="' + data['id'] + '" class="zbsbulkcb" /><label for="zbsbulk' + data['id'] + '"></label></div></td>';
                    }
        ...
        */
        ...
        function zeroBSCRMJS_listView_draw_totals_tables(){
            ...
            if ( typeof window.jpcrm_totals_table != "undefined" && window.jpcrm_totals_table !== null ){
                ...
                if ( typeof window.jpcrm_totals_table.quotes_total_formatted != "undefined" && window.jpcrm_totals_table.quotes_total_formatted !== null ){
                    
                    table_body_html += '<tr><td>' + zeroBSCRMJS_listViewLang( 'quotes' ) + '</td><td>' + window.jpcrm_totals_table.quotes_total_formatted + '</td></tr>';

                }

                if ( typeof window.jpcrm_totals_table.invoices_total_formatted != "undefined" && window.jpcrm_totals_table.invoices_total_formatted !== null ){
                    
                    table_body_html += '<tr><td>' + zeroBSCRMJS_listViewLang( 'invoices' ) + '</td><td>' + window.jpcrm_totals_table.invoices_total_formatted + '</td></tr>';

                }

                if ( typeof window.jpcrm_totals_table.transactions_total_formatted != "undefined" && window.jpcrm_totals_table.transactions_total_formatted !== null ){
                    
                    table_body_html += '<tr><td>' + zeroBSCRMJS_listViewLang( 'transactions' ) + '</td><td>' + window.jpcrm_totals_table.transactions_total_formatted + '</td></tr>';

                }
                if ( typeof window.jpcrm_totals_table.total_sum_formatted != "undefined" && window.jpcrm_totals_table.total_sum_formatted !== null ){
                    
                    table_footer_html = '<tfoot><tr><td>' + zeroBSCRMJS_listViewLang( 'total' ) + '</td><td>' + window.jpcrm_totals_table.total_sum_formatted + '</td></tr></tfoot>';

                }

                if ( table_body_html !== '' ){

                    jQuery( '#jpcrm-listview-totals-box' ).html( '<h4>' + zeroBSCRMJS_listViewLang( 'totals' ) + '</h4><table class="ui compact definition table"><tbody>' + table_body_html + '</tbody>' + table_footer_html + '</table>' );
...
==================================================================================== */
        ...
        function zeroBSCRMJS_listView_invoice_date(dataLine){
            ...
            var v = '';
            if ( dataLine['date_date'] ) v = dataLine['date_date'];
        ...
        function zeroBSCRMJS_listView_invoice_due(dataLine){
            ...
            var v = '';
            if ( dataLine['due_date_date'] ) v = dataLine['due_date_date'];
