...
class BWFAN_API_Get_Tools_Setting extends BWFAN_API_Base {
	...
	public function process_api_call() {
		...
		if ( bwfan_is_woocommerce_active() ) { // check for woocommerce
			$tool_settings[] = array(
				"title"          => __( "Delete Autonami Generated Expired Coupons", "wp-marketing-automations" ),
				"description"    => __( "This will schedule the deletion of all the expired coupons generated by Autonami", "wp-marketing-automations" ),
				"task"           => "delete_expired_coupons",
				"task_text"      => __( "Delete", "wp-marketing-automations" ),
				"processingText" => __( "We are deleting all expired coupons generated by Autonami", "wp-marketing-automations" ),
			);
