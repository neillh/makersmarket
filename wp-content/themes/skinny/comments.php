...
<div id="comments" class="comments-area">
	<div class="comments-inner <?php echo esc_attr( Skinny\site_container_class( 'singular-content' ) ); ?>">

	<?php
	// You can start editing here -- including this comment!
	if ( have_comments() ) :
		?>
		<h2 class="comments-title highlight-heading">
			<?php
			$comment_count = get_comments_number();

			printf( // phpcs:ignore
			/* translators: 1: comment count number, 2: title. */
				esc_html( _nx( '%1$s comment', '%1$s comments', $comment_count, 'comments title', 'skinny' ) ),
	...
	comment_form( array(
		'label_submit' => __( 'Submit Comment', 'skinny' ),
		'title_reply'  => __( 'Join the discussion', 'skinny' ),
	) );
	?>
	</div><!-- .comments-inner -->
</div><!-- #comments -->
