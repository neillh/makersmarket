...
if ( ! class_exists( 'Cartflows_Pro_Gb_Block_Product_Quantity' ) ) {
	...
	class Cartflows_Pro_Gb_Block_Product_Quantity {
		...
		public function register_blocks() {
			...
			$content_border_attr = Cartflows_Pro_Gb_Helper::generate_php_border_attribute( 'content' );
			...
			$attr = array_merge( $content_border_attr, $attr );
	...
	/**
	 *  Prepare if class 'Cartflows_Pro_Gb_Block_Product_Quantity' exist.
	 *  Kicking this off by calling 'get_instance()' method
	 */
	Cartflows_Pro_Gb_Block_Product_Quantity::get_instance();
}
