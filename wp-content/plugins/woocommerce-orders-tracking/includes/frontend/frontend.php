...
//		$has_shortcode = has_shortcode( get_the_content(), 'vi_wot_form_track_order' );
//		if ( is_customize_preview() ) {
//			if ( ! $has_shortcode ) {
//				$content .= do_shortcode( '[vi_wot_form_track_order preview="true"]' );
//			}
//		} elseif ( self::$settings->get_params( 'service_carrier_enable' ) ) {
//			if ( ! $has_shortcode ) {
//				$content .= do_shortcode( '[vi_wot_form_track_order]' );
//			}
//		}
