...
class GoogleAddressAutocomplete extends FeaturesAbstract {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'cfw-google-places', "https://maps.googleapis.com/maps/api/js?key={$google_api_key}&libraries=places&language={$language}", array( 'woocommerce' ), CFW_VERSION, true );
	}
