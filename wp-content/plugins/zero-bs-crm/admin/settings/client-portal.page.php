				...
				<div class="segment ui">
					<?php 
						echo zeroBSCRM_UI2_messageHTML(
							...
							'You do not currently have the Client Portal enabled, you can enable it <a href="' . zbsLink( $zbs->slugs['modules'] ) . '" target="_blank">here</a>.'
						); 
					?>
				</div>
				</div>
...
if (isset($_POST['editwplf']) && zeroBSCRM_isZBSAdminOrAdmin()){
    ...
    $updatedSettings['portal_transactions_show_status'] = ''; if (isset($_POST['wpzbscrm_portal_transactions_show_status']) && !empty($_POST['wpzbscrm_portal_transactions_show_status'])) $updatedSettings['portal_transactions_show_status'] = 1;
...
<div id="sbA">
    <form method="post" action="?page=<?php echo $zbs->slugs['settings']; ?>&tab=clients">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_portal_transactions_show_status"><?php _e('Show transaction status',"zero-bs-crm"); ?></label><br /><?php _e('Tick to show the transaction status in the transactions page in Client Portal.',"zero-bs-crm"); ?>
                </td>
                <td style="width:540px"><input type="checkbox" class="winput form-control" name="wpzbscrm_portal_transactions_show_status" id="wpzbscrm_portal_transactions_show_status" value="1"<?php if (isset($settings['portal_transactions_show_status']) && $settings['portal_transactions_show_status'] == "1") echo ' checked="checked"'; ?> /></td>
            </tr>
