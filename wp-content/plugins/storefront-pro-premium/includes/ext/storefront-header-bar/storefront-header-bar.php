...
final class Storefront_Header_Bar {
	...
	public function shb_styles() {
		...
		$footer_bar_bg 			= get_theme_mod( 'shb_background_color', apply_filters( 'storefront_default_header_background_color', '#2c2d33' ) );
		$footer_bar_text 		= get_theme_mod( 'shb_text_color', apply_filters( 'storefront_default_header_text_color', '#9aa0a7' ) );
		$footer_bar_headings 	= get_theme_mod( 'shb_heading_color', apply_filters( 'shb_default_heading_color', '#ffffff' ) );
		$footer_bar_links 		= get_theme_mod( 'shb_link_color', apply_filters( 'storefront_default_header_link_color', '#ffffff' ) );
