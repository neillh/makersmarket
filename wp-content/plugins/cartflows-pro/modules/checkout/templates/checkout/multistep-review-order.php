...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-name"><?php esc_html_e( 'Products', 'cartflows-pro' ); ?></th>
			<th class="product-total"><?php esc_html_e( 'Subtotal', 'cartflows-pro' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'cartflows-pro' ); ?></th>
		...
		if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) :
			...
			<tr class="cart-shipping">
				<th><?php esc_html_e( 'Shipping', 'cartflows-pro' ); ?></th>
