    ...
    <table class="table table-bordered table-striped wtab">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="ui fluid input" style="min-width: 150px;">
                            <input type="text" name="jpcrm_oauth_setting_<?php echo $editing_provider; ?>_id" id="jpcrm_oauth_setting_<?php echo $editing_provider; ?>_id" placeholder="<?php echo sprintf( __( 'e.g. %s', 'zero-bs-crm' ), '595387679191-32p8h47uwks4e0kfcct50irbsj8o8rmp.apps.domain.com' ); ?>" value="<?php echo !empty( $provider_config['id'] ) ? esc_html( $provider_config['id'] ) : ''; ?>" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="ui fluid input" style="min-width: 150px;">
                            <input type="text" name="jpcrm_oauth_setting_<?php echo $editing_provider; ?>_secret" id="jpcrm_oauth_setting_<?php echo $editing_provider; ?>_secret" placeholder="<?php echo sprintf( __( 'e.g. %s', 'zero-bs-crm' ), 'KEOCPW-uRiDf-CZsGlXDrtWM2ZJXUqj10aT' ); ?>" value="<?php echo !empty( $provider_config['secret'] ) ? esc_html( $provider_config['secret'] ) : ''; ?>" />
                        </div>
                    </td>
                </tr>
