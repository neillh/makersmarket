...
class VI_WOOCOMMERCE_ORDERS_TRACKING_ADMIN_SETTINGS {
	...
	public function save_settings() {
		...
		if ( $pagenow === 'admin.php' && $page === 'woocommerce-orders-tracking' ) {
			...
			if ( isset( $_POST['_vi_wot_setting_nonce'] ) && wp_verify_nonce( $_POST['_vi_wot_setting_nonce'], 'vi_wot_setting_action_nonce' ) ) {
				...
				$args['manage_tracking']                          = isset( $_POST['woo-orders-tracking-settings']['manage_tracking'] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['manage_tracking'] ) : '';
				$args['track_per_quantity']                       = isset( $_POST['woo-orders-tracking-settings']['track_per_quantity'] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['track_per_quantity'] ) : '';
				$args['edit_single_tracking_old_ui']              = isset( $_POST['woo-orders-tracking-settings']['edit_single_tracking_old_ui'] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['edit_single_tracking_old_ui'] ) : '';
				...
				$args['paypal_add_after_aliexpress_order_synced'] = isset( $_POST['woo-orders-tracking-settings']['paypal']['paypal_add_after_aliexpress_order_synced'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['paypal']['paypal_add_after_aliexpress_order_synced'] ) : '';
				...
				$args['sms_send_after_aliexpress_order_synced']   = isset( $_POST['woo-orders-tracking-settings']['sms_send_after_aliexpress_order_synced'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['sms_send_after_aliexpress_order_synced'] ) : '';
				...
				$args['default_track_info_enable']          = isset( $_POST['woo-orders-tracking-settings']['default_track_info_enable'] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['default_track_info_enable'] ) : '';
				$args['default_track_info_number']          = isset( $_POST['woo-orders-tracking-settings']['default_track_info_number'] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['default_track_info_number'] ) : '';
				$args['default_track_info_carrier']         = isset( $_POST['woo-orders-tracking-settings']['default_track_info_carrier'] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['default_track_info_carrier'] ) : '';
				$args['default_track_info_position']        = isset( $_POST['woo-orders-tracking-settings']['default_track_info_position'] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['default_track_info_position'] ) : '';
				$args['default_track_info_content']         = isset( $_POST['woo-orders-tracking-settings']['default_track_info_content'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['default_track_info_content'] ) : '';
				$args['translate_timeline']                 = isset( $_POST['woo-orders-tracking-settings']['translate_timeline'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['translate_timeline'] ) : '';
				$args['cloud_translation_api']              = isset( $_POST['woo-orders-tracking-settings']['cloud_translation_api'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['cloud_translation_api'] ) : '';
				$args['dianxiaomi_enable']                  = isset( $_POST['woo-orders-tracking-settings']['dianxiaomi_enable'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['dianxiaomi_enable'] ) : '';
				$args['dianxiaomi_change_status']           = isset( $_POST['woo-orders-tracking-settings']['dianxiaomi_change_status'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['dianxiaomi_change_status'] ) : '';
				$args['save_carrier_name_in_post_meta']     = isset( $_POST['woo-orders-tracking-settings']['save_carrier_name_in_post_meta'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['save_carrier_name_in_post_meta'] ) : '';
				$args['dianxiaomi_send_email']              = isset( $_POST['woo-orders-tracking-settings']['dianxiaomi_send_email'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['dianxiaomi_send_email'] ) : '';
				...
				if ( current_user_can( 'manage_options' ) ) {
					foreach ( VI_WOOCOMMERCE_ORDERS_TRACKING_DATA::get_functionality() as $gf_key => $gf_value ) {
						$args['capabilities'][ $gf_key ] = isset( $_POST['woo-orders-tracking-settings']['capabilities'][ $gf_key ] ) ? self::stripslashes( $_POST['woo-orders-tracking-settings']['capabilities'][ $gf_key ] ) : '';
					}
				...
				$ft_messages     = isset( $_POST['woo-orders-tracking-settings']['default_track_info_message'] ) ? self::stripslashes_deep( $_POST['woo-orders-tracking-settings']['default_track_info_message'] ) : array();
				$default_message = array();
				if ( count( $ft_messages ) ) {
					foreach ( $ft_messages['description'] as $ft_message_key => $description ) {
						$default_message[] = array(
							'time'           => DAY_IN_SECONDS * absint( $ft_messages['day'][ $ft_message_key ] ) + HOUR_IN_SECONDS * absint( $ft_messages['hour'][ $ft_message_key ] ) + MINUTE_IN_SECONDS * absint( $ft_messages['minute'][ $ft_message_key ] ),
							'description'    => $description,
							'location'       => '',
							'status'         => $ft_messages['status'][ $ft_message_key ],
							'order_statuses' => $ft_messages['order_statuses'][ $ft_message_key ] ? vi_wot_json_decode( $ft_messages['order_statuses'][ $ft_message_key ] ) : array(),
						);
					}
				...
				if ( ! $save_carrier_name_in_post_meta_old && $args['save_carrier_name_in_post_meta'] ) {
					...
					foreach ( $the_query->posts as $order_id ) {
						$_wot_tracking_carrier = get_post_meta( $order_id, '_wot_tracking_carrier', true );
						if ( $_wot_tracking_carrier ) {
							...
							if ( $carrier ) {
								...
								update_post_meta( $order_id, '_wot_tracking_carrier_name', $display_name );
							}
						}
					}
				}
            ...
            <div class="vi-ui raised">
                <form action="" class="vi-ui form" method="post">
                    ...
                    <div class="vi-ui vi-ui-main top tabular attached menu ">
                        ...
                        <a class="item" data-tab="shipping_carriers">
						...
						if ( current_user_can( 'manage_options' ) ) {
                            ...
                            <a class="item" data-tab="advanced">
								<?php esc_html_e( 'Advanced Settings', 'woocommerce-orders-tracking' ) ?>
                            </a>
							<?php
						}
						if ( class_exists( 'VI_WOOCOMMERCE_ALIDROPSHIP' ) && version_compare( VI_WOOCOMMERCE_ALIDROPSHIP_VERSION, '1.0.0.6', '>=' ) ) {
							?>
                            <a class="item" data-tab="ald">
								<?php esc_html_e( 'ALD dropshipping', 'woocommerce-orders-tracking' ) ?>
                            </a>
							<?php
						}
						?>
                        <a class="item" data-tab="integration">
							<?php esc_html_e( 'Integration', 'woocommerce-orders-tracking' ) ?>
                        </a>
						<?php
						if ( current_user_can( 'manage_options' ) ) {
							?>
                    ...
                    <div class="vi-ui bottom attached tab segment active" data-tab="general">
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label for="<?php echo esc_attr( self::set( 'manage_tracking' ) ) ?>"><?php esc_html_e( 'Manage tracking by', 'woocommerce-orders-tracking' ) ?></label>
                                </th>
                                <td>
									<?php
                                    ...
                                    <p class="description"><?php esc_html_e( 'Before, you had to set tracking number for every item of an order even if the order uses only one tracking number for all of its items.', 'woocommerce-orders-tracking' ) ?></p>
                                    <p class="description"><?php esc_html_e( 'Now, if your tracking system works that way, you can choose to manage tracking by "Order only".', 'woocommerce-orders-tracking' ) ?></p>
                                    <p class="description"><?php esc_html_e( 'Orders whose items already have tracking number(s) will not be affected by this feature.', 'woocommerce-orders-tracking' ) ?></p>
                                    <p class="description">
                                        <strong><?php esc_html_e( '*Important', 'woocommerce-orders-tracking' ) ?>
                                            : </strong><?php esc_html_e( 'If you do AliExpress dropshipping, please DO NOT choose "Order only" as each item of an AliExpress order can have its own tracking number. If our dropshipping plugin(ALD) is active, it will override this feature to make tracking number field available for every item of an order.', 'woocommerce-orders-tracking' ) ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <label for="<?php echo esc_attr( self::set( 'track_per_quantity' ) ) ?>"><?php esc_html_e( 'Track per item quantity', 'woocommerce-orders-tracking' ) ?></label>
                                </th>
                                <td>
                                    <div class="vi-ui toggle checkbox">
                                        <input type="checkbox"
                                               name="<?php echo esc_attr( self::set( 'settings' ) ) ?>[track_per_quantity]"
                                               id="<?php echo esc_attr( self::set( 'track_per_quantity' ) ) ?>"
                                               value="1" <?php checked( $this->settings->get_params( 'track_per_quantity' ), '1' ) ?>><label></label>
                                    </div>
                                    <p class="description"><?php esc_html_e( 'If enabled, there will a tracking number field for each purchased quantity of an order item. "Manage tracking by" must NOT be set to "Order only"', 'woocommerce-orders-tracking' ) ?></p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
					...
					if ( class_exists( 'VI_WOOCOMMERCE_ALIDROPSHIP' ) && version_compare( VI_WOOCOMMERCE_ALIDROPSHIP_VERSION, '1.0.0.6', '>=' ) ) {
                        ...
                        <div class="vi-ui bottom attached tab segment" data-tab="ald">
                            <div class="vi-ui small positive message">
                                <div><?php esc_html_e( 'Compatibility with our ALD - Aliexpress Dropshipping and Fulfillment for WooCommerce plugin', 'woocommerce-orders-tracking' ) ?></div>
                            </div>
                            <table class="form-table">
                                <tbody>
                                <tr>
                                    <th>
                                        <label for="<?php echo esc_attr( self::set( 'email_send_after_aliexpress_order_synced' ) ) ?>"><?php esc_html_e( 'Send email', 'woocommerce-orders-tracking' ) ?></label>
                                    </th>
                                    <td>
                                        <div class="vi-ui toggle checkbox">
                                            <input type="checkbox"
                                        ...
                                        <p class="description"><?php esc_html_e( 'When syncing AliExpress orders(by ALD plugin), send tracking info email to customers if tracking number updated or tracking status switches to delivered', 'woocommerce-orders-tracking' ) ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        <label for="<?php echo esc_attr( self::set( 'sms_send_after_aliexpress_order_synced' ) ) ?>"><?php esc_html_e( 'Send SMS', 'woocommerce-orders-tracking' ) ?></label>
                                    </th>
                                    <td>
                                        <div class="vi-ui toggle checkbox">
                                            <input type="checkbox"
                                        ...
                                        <p class="description"><?php esc_html_e( 'When syncing AliExpress orders(by ALD plugin), send SMS to customers if tracking number updated or tracking status switches to delivered', 'woocommerce-orders-tracking' ) ?></p>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        <label for="<?php echo esc_attr( self::set( 'paypal_add_after_aliexpress_order_synced' ) ) ?>"><?php esc_html_e( 'Add tracking number to PayPal', 'woocommerce-orders-tracking' ) ?></label>
                                    </th>
                                    <td>
                                        <div class="vi-ui toggle checkbox">
                                            <input type="checkbox"
                                        ...
                                        <p class="description"><?php esc_html_e( 'When syncing AliExpress orders(by ALD plugin), automatically add tracking number to PayPal. Make sure you configure PayPal API correctly', 'woocommerce-orders-tracking' ) ?></p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="vi-ui bottom attached tab segment" data-tab="integration">
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label for="<?php echo esc_attr( self::set( 'save_carrier_name_in_post_meta' ) ) ?>"><?php esc_html_e( 'Save carrier (display)name in post meta', 'woocommerce-orders-tracking' ) ?></label>
                                </th>
                                <td>
                                    <div class="vi-ui toggle checkbox">
                                        <input type="checkbox"
                                               ...
                                               value="1" <?php checked( $this->settings->get_params( 'save_carrier_name_in_post_meta' ), '1' ) ?>><label><?php esc_html_e( 'Yes', 'woocommerce-orders-tracking' ) ?></label>
                                    </div>
                                    <p><?php printf( esc_html__( 'If enabled, carrier\'s display name will be saved to %s post meta so that you can use this meta to integrate with other plugins', 'woocommerce-orders-tracking' ), '<strong>_wot_tracking_carrier_name</strong>' ) ?></p>
                                    <p>
                                        <strong>*</strong><?php esc_html_e( 'This is only used for orders that a tracking number is used for the whole order(manage tracking by order only)', 'woocommerce-orders-tracking' ) ?>
                                    </p>
                                </td>
                            </tr>
                            </tbody>
	...
	private function shipping_carriers_settings() {
        ...
        <div class="vi-ui positive small message"><?php esc_html_e( 'To turn off a carrier that is currently the default carrier(the first one), you first have to set another carrier as the default by hovering over it then click the pointing hand icon.', 'woocommerce-orders-tracking' ) ?></div>
                ...
                <td>
                    <select class="vi-ui dropdown"
						...
						foreach ( $sms_providers as $sms_provider_k => $sms_provider_v ) {
							?>
                            <option value="<?php echo esc_attr( $sms_provider_k ) ?>" <?php selected( $sms_provider_k, $sms_provider ) ?>><?php echo esc_html( $sms_provider_v ) ?></option>
							<?php
						}
						?>
                    </select>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="<?php echo esc_attr( self::set( 'settings' ) ) ?>[email_woo][email_woo_status][]"
                            ...
                            class="vi-ui dropdown <?php echo esc_attr( self::set( 'setting-email-woo-status' ) ) ?>"
                            multiple>
						<?php
                ...
                <td>
                    ...
                    <select name="<?php echo esc_attr( self::set( 'settings' ) ) ?>[email_woo][email_woo_position]"
						...
						foreach ( $email_woo_positions as $email_woo_position_k => $email_woo_position_v ) {
							?>
                            <option value="<?php echo esc_attr( $email_woo_position_k ) ?>" <?php selected( $email_woo_position, $email_woo_position_k ) ?>><?php echo esc_html( $email_woo_position_v ) ?></option>
							<?php
						}
						?>
                    </select>
		...
		if ( is_array( $available_paypal_methods ) && count( $available_paypal_methods ) ) {
            ...
            <div class="vi-ui positive message">
                ...
                <ul class="list">
                    ...
                    <li><?php echo wp_kses_post( __( 'Go to My Apps & Credentials and select the <strong>Live</strong> tab(for live API) or <strong>Sandbox</strong> tab(for sandbox API)', 'woocommerce-orders-tracking' ) ) ?></li>
                    ...
                    <li><?php esc_html_e( 'If you use the same API for all PayPal payments, you only need to enter API for the default Live/Sandbox API field', 'woocommerce-orders-tracking' ); ?></li>
                    <li><?php echo wp_kses_post( __( '<strong>*Caution:</strong> sandbox API CANNOT be used for orders created in live environment and vice versa.', 'woocommerce-orders-tracking' ) ) ?></li>
                </ul>
            </div>
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php esc_html_e( 'If enabled, raw request to PayPal API will be logged whenever there\'s an error', 'woocommerce-orders-tracking' ) ?></p>
                    </td>
                </tr>
                </tbody>
            </table>
	...
	private function tracking_service_settings() {
        ...
        <div class="vi-ui positive small message">
            ...
            <ul class="list">
                <li><?php echo VI_WOOCOMMERCE_ORDERS_TRACKING_DATA::wp_kses_post( sprintf( __( 'Branded tracking form shortcode %s. This only works if you use a tracking service. By default, tracking form is appended to the tracking page. If you want to change the tracking form\'s position, especially when the tracking page is built with an UX builder, this shortcode is very helpful.', 'woocommerce-orders-tracking' ), '<span data-tooltip="' . esc_attr__( 'Click to copy' ) . '"><input type="text" class="wot-input-shortcode-field" readonly value="[vi_wot_form_track_order]"></span>' ) ) ?></li>
                <li><?php echo VI_WOOCOMMERCE_ORDERS_TRACKING_DATA::wp_kses_post( sprintf( __( 'TrackingMore tracking form shortcode %s. You can still use this shortcode even if you do not use tracking service. More details about this at <a target="_blank" href="https://www.trackingmore.com/embed_box_float-en.html">Track Button</a>', 'woocommerce-orders-tracking' ), '<span data-tooltip="' . esc_attr__( 'Click to copy' ) . '"><input type="text" class="wot-input-shortcode-field" readonly value="[vi_wot_tracking_more_form]"></span>' ) ) ?></li>
            </ul>
        </div>
        <table class="form-table">
            <tbody>
                ...
                <td>
                    <select name="<?php echo esc_attr( self::set( 'settings' ) ) ?>[service_carrier][service_carrier_type]"
						...
						foreach ( VI_WOOCOMMERCE_ORDERS_TRACKING_DATA::service_carriers_list() as $item_slug => $item_name ) {
							?>
                            <option value="<?php echo esc_attr( $item_slug ) ?>" <?php selected( $service_carrier_type, $item_slug ) ?>><?php echo esc_html( $item_name ); ?></option>
							<?php
						}
						?>
                    </select>
                    <p class="description"><?php esc_html_e( 'As Cainiao does not support API, it\'s unstable to use.', 'woocommerce-orders-tracking' ) ?></p>
                    <p class="description"><?php echo wp_kses_post( __( '<strong>Notice</strong>: for some tracking services, API access is NOT available for a free plan.', 'woocommerce-orders-tracking' ) ) ?></p>
                </td>
            </tr>
            ...
            <tr class="<?php echo esc_attr( self::set( $api_key_class ) ) ?>">
                ...
                <td>
                    ...
                    <p class="description <?php echo esc_attr( self::set( array(
						...
						<?php
						echo wp_kses_post( __( 'Please enter your TrackingMore api key. If you don\'t have an account, <a href="https://my.trackingmore.com/get_apikey.php" target="_blank"><strong>click here</strong></a> to create one and generate api key', 'woocommerce-orders-tracking' ) );
						?>
                    </p>
                    <p class="description <?php echo esc_attr( self::set( array(
						...
						<?php echo wp_kses_post( __( 'Please enter your AfterShip api key. If you don\'t have an account, <a href="https://help.aftership.com/hc/en-us/articles/115008353227-How-to-generate-AfterShip-API-Key-" target="_blank"><strong>click here</strong></a> to create one and generate api key', 'woocommerce-orders-tracking' ) ) ?>
                    </p>
                    <p class="description <?php echo esc_attr( self::set( array(
						...
						<?php echo wp_kses_post( __( 'Please enter your EasyPost api key. If you don\'t have an account, <a href="https://www.easypost.com/signup" target="_blank"><strong>click here</strong></a> to create one and generate api key', 'woocommerce-orders-tracking' ) ) ?>
                    </p>
                    <p class="description <?php echo esc_attr( self::set( array(
						...
						<?php echo wp_kses_post( __( 'Please enter your 17track api key. If you don\'t have an account, <a href="https://user.17track.net/en/register" target="_blank"><strong>click here</strong></a> to create one then go to <a target="_blank" href="https://api.17track.net/en/admin/settings">Settings</a> to copy/change API key', 'woocommerce-orders-tracking' ) ) ?>
                    </p>
                    <p class="description <?php echo esc_attr( self::set( array(
						...
						<?php echo wp_kses_post( __( 'Please enter your Tracktry api key. If you don\'t have an account, <a href="https://www.tracktry.com/signup-en.html" target="_blank"><strong>click here</strong></a> to create one then go to <a target="_blank" href="https://my.tracktry.com/setting">Settings</a> to copy API key', 'woocommerce-orders-tracking' ) ) ?>
                    </p>
                </td>
            </tr>
            <tr class="<?php echo esc_attr( self::set( $api_key_class ) ) ?>">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select class="vi-ui dropdown"
                        ...
                        <option value="site_language" <?php selected( $translate_timeline, 'site_language' ) ?>><?php esc_html_e( 'Site language', 'woocommerce-orders-tracking' ); ?></option>
                    ...
                    <p class="description"><?php printf( __( 'Using <a target="_blank" href="%s">Google Cloud Translation API</a> to translate timeline to a specific language', 'woocommerce-orders-tracking' ), 'https://cloud.google.com/translate/docs/basic/translating-text' ) ?></p>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    ...
                    <p class="description"><?php printf( __( 'This functionality uses Cloud Translation - Basic API, please click <a target="_blank" href="%s">here</a> to read more about pricing', 'woocommerce-orders-tracking' ), 'https://cloud.google.com/translate/pricing#cloud-translation---basic' ) ?></p>
                    <p class="description"><?php printf( __( 'To get API key, please read <a target="_blank" href="%s">https://cloud.google.com/docs/authentication/api-keys#creating_an_api_key</a> or watch our guiding video below', 'woocommerce-orders-tracking' ), 'https://cloud.google.com/docs/authentication/api-keys#creating_an_api_key' ) ?></p>
        ...
        <div class="vi-ui positive small message">
            ...
            <ul class="list">
                <li><?php esc_html_e( 'This feature is to reduce after-purchase support for new orders when tracking number is not available, or available but without any info', 'woocommerce-orders-tracking' ) ?></li>
        ...
        <table class="vi-ui form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'Show below track info in tracking timeline if a real tracking number does not have any information from tracking service', 'woocommerce-orders-tracking' ) ?></p>
                </td>
            </tr>
            <tr>
                <th>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php _e( 'If an order does not have a tracking number, default tracking number will be displayed on Order received page, My account/orders and in emails that you configure in <a href="#email_woo">WooCommerce Email tab</a>.', 'woocommerce-orders-tracking' ) ?></p>
                    <p class="description"><?php esc_html_e( 'When a customer uses a "default tracking number" to track, the default track info will be used.', 'woocommerce-orders-tracking' ) ?></p>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
					...
					?>
                    <p class="description"><?php esc_html_e( 'Message including default tracking number which will be displayed on Order received page or WooCommerce email.', 'woocommerce-orders-tracking' ) ?></p>
					<?php
            ...
            <tr>
                ...
                <td>
                    ...
                    <select class="vi-ui dropdown"
                        ...
                        <option value="before_order_table" <?php selected( $default_position, 'before_order_table' ) ?>><?php esc_html_e( 'Before order table', 'woocommerce-orders-tracking' ); ?></option>
                        <option value="after_order_table" <?php selected( $default_position, 'after_order_table' ) ?>><?php esc_html_e( 'After order table', 'woocommerce-orders-tracking' ); ?></option>
                    </select>
                ...
                <div class="edit-shipping-carrier-html-content-body">
                    ...
                    <div class="edit-shipping-carrier-html-content-body-row">
                        <div class="edit-shipping-carrier-html-content-body-carrier-url-wrap">
                            ...
                            <p class="description wotv-error-tracking-url"><?php esc_html_e( 'The tracking url will not include tracking number because carrier URL does not include {tracking_number}', 'woocommerce-orders-tracking' ) ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="add-new-shipping-carrier-html-content-body">
                    <div class="add-new-shipping-carrier-html-content-body-row add-new-shipping-carrier-html-content-body-row-choose-from">
                        <div class="add-new-shipping-carrier-html-content-body-add-carrier-type-wrap">
                            <label for="add-new-shipping-carrier-html-content-body-add-carrier-type"><?php esc_html_e( 'Add your own carrier or choose from', 'woocommerce-orders-tracking' ) ?></label>
                        ...
                        <div class="add-new-shipping-carrier-html-content-body-choose-from-wrap add-new-shipping-carrier-html-content-body-choose-from-trackingmore-wrap">
                            <label for="add-new-shipping-carrier-html-content-body-choose-from-trackingmore"><?php esc_html_e( 'Select a carrier', 'woocommerce-orders-tracking' ) ?></label>
                        ...
                        <div class="add-new-shipping-carrier-html-content-body-choose-from-wrap add-new-shipping-carrier-html-content-body-choose-from-17track-wrap">
                            <label for="add-new-shipping-carrier-html-content-body-choose-from-17track"><?php esc_html_e( 'Select a carrier', 'woocommerce-orders-tracking' ) ?></label>
                            <select class="vi-ui fluid search"
                        ...
                        <div class="add-new-shipping-carrier-html-content-body-choose-from-wrap add-new-shipping-carrier-html-content-body-choose-from-tracktry-wrap">
                            <label for="add-new-shipping-carrier-html-content-body-choose-from-tracktry"><?php esc_html_e( 'Select a carrier', 'woocommerce-orders-tracking' ) ?></label>
                            <select class="vi-ui fluid search"
                    ...
                    <div class="add-new-shipping-carrier-html-content-body-row">
                        <div class="add-new-shipping-carrier-html-content-body-carrier-name-wrap">
                            <label for="add-new-shipping-carrier-html-content-body-carrier-name"><?php esc_html_e( 'Carrier Name(required)', 'woocommerce-orders-tracking' ) ?></label>
                    ...
                    <div class="add-new-shipping-carrier-html-content-body-row">
                        <div class="add-new-shipping-carrier-html-content-body-carrier-url-wrap">
                            <label for="add-new-shipping-carrier-html-content-body-carrier-url"><?php esc_html_e( 'Carrier URL(required)', 'woocommerce-orders-tracking' ) ?></label>
                            ...
                            <p class="description"><?php esc_html_e( 'eg: https://www.dhl.com/en/express/tracking.html?AWB={tracking_number}&brand=DHL', 'woocommerce-orders-tracking' ); ?></p>
                            <p class="description wotv-error-tracking-url"><?php esc_html_e( 'The tracking url will not include tracking number if carrier URL does not include {tracking_number}', 'woocommerce-orders-tracking' ) ?></p>
                        </div>
                    </div>
                </div>
